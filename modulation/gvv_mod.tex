...
\section{Multivariate Gaussian: Coherent BFSK}
...
\times 
\rsbrak{
\cbrak{\frac{\brak{x-\mu_x}^2}{\sigma_x^2}+\frac{\brak{y-\mu_y}^2}{\sigma_y^2}}
-
\frac{2\rho\brak{x-\mu_x}\brak{y-\mu_y}}{\sigma_x\sigma_y}}
\end{multline}
}
%
where
