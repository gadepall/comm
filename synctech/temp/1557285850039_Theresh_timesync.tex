...
At the receiver, let us consider we have sent two types of transmission. One is PLHEADER+DATA and another is only DATA.
...
Fig.\ref{fig:frameoff} shows ROC curves at the receiver for frame synchronization at $\frac{E_b}{N_0}=-2$ dB
