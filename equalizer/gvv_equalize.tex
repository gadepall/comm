...
\title{
%	\logo{
Robust equalizer with time/frequency synchronization at the receiver to  sustain fading effects of
V/UHF channel
%	}
}
...
\bibliography{IEEEabrv,./chapters/equalizer_design}
\end{document}
