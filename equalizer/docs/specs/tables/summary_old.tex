...
\hhline{|---|}
	...
	{}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}Total}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedleft}750000}
\\
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}4}
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedleft}900000}
\\
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}6}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}Service tax (14.5\% of overall cost)}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedleft}130500}
\\
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedleft}\textbf{1030500}}
\\
\hhline{|-|-|-|}
%\end{longtable}
\end{tabular}
