...
\hhline{|-|-|-}
	...
	{\gnumericPB{\raggedleft}\gnumbox[r]{\textbf{Value}}}
\\
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedleft}\gnumbox[r]{10 MHz}}
\\
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedleft}\gnumbox[r]{100 MHz}}
\\
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedleft}\gnumbox[r]{$3\times10^8 ms^{-1}$}}
\\
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedleft}\gnumbox[r]{$\mathcal{N}\brak{0,1}$}}
\\
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
